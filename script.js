...
// Coordenadas actualizadas según tus puntos
...
async function cargarDatos() {
    try {
        ...
        if (data.records) {
            ...
            document.getElementById('status').innerText = `CONECTADO: ${data.records.length}`;
